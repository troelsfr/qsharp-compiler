...
define internal double @Microsoft__Quantum__Qir__Emission__ClassicalUpdateMu__body(double %mu, double %sigma, %Result* %res) {
entry:
  %0 = call %Result* @__quantum__rt__result_get_zero()
  %1 = call i1 @__quantum__rt__result_equal(%Result* %res, %Result* %0)
  br i1 %1, label %condTrue__1, label %condFalse__1
...
condContinue__1:                                  ; preds = %condFalse__1, %condTrue__1
  %6 = phi double [ %3, %condTrue__1 ], [ %5, %condFalse__1 ]
  ret double %6
}
...
header__1:                                        ; preds = %exiting__1, %entry
  %0 = phi i64 [ 1, %entry ], [ %6, %exiting__1 ]
  %1 = icmp sle i64 %0, 4
...
body__1:                                          ; preds = %header__1
  ...
  %c1 = call double @Microsoft__Quantum__Qir__Emission__ClassicalComputeInput1__body(double %2, double %3)
  %c2 = call double @Microsoft__Quantum__Qir__Emission__ClassicalComputeInput2__body(double %2, double %3)
  %datum = call %Result* @Microsoft__Quantum__Qir__Emission__Iterate__body(double %c1, double %c2, %Qubit* %target, %Qubit* %aux)
  %4 = call double @Microsoft__Quantum__Qir__Emission__ClassicalUpdateMu__body(double %2, double %3, %Result* %datum)
  store double %4, double* %mu, align 8
  %5 = call double @Microsoft__Quantum__Qir__Emission__ClassicalUpdateSigma__body(double %3)
  store double %5, double* %sigma, align 8
...
exit__1:                                          ; preds = %header__1
  %7 = load double, double* %mu, align 8
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___d09908006690421cab92bd78d346ff27___QsRef23__ApplyWithLessControlsA____body(%Callable* %47, { %Array*, %Qubit* }* %49)
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___d09908006690421cab92bd78d346ff27___QsRef23__ApplyWithLessControlsA____body(%Callable* %14, { %Array*, %Qubit* }* %16)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___0e27d13d8cb34a28b2100e2bc596a1f9___QsRef23__ApplyWithLessControlsA____body(%Callable* %10, { %Array*, { %Qubit*, %Qubit* }* }* %12)
...
define internal void @Microsoft__Quantum__Intrinsic___0e27d13d8cb34a28b2100e2bc596a1f9___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___d09908006690421cab92bd78d346ff27___QsRef23__ApplyWithLessControlsA____body(%Callable* %7, { %Array*, %Qubit* }* %9)
...
define internal void @Microsoft__Quantum__Intrinsic___d09908006690421cab92bd78d346ff27___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___090adfe379c447b396020a430db68fa6___QsRef23__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, { double, %Qubit* }* }* %17)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___090adfe379c447b396020a430db68fa6___QsRef23__ApplyWithLessControlsA____body(%Callable* %16, { %Array*, { double, %Qubit* }* }* %18)
...
define internal void @Microsoft__Quantum__Intrinsic___090adfe379c447b396020a430db68fa6___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  store %Qubit* %qubit, %Qubit** %17, align 8
  call void @Microsoft__Quantum__Intrinsic___d09908006690421cab92bd78d346ff27___QsRef23__ApplyWithLessControlsA____body(%Callable* %13, { %Array*, %Qubit* }* %15)
...
define internal void @Microsoft__Quantum__Intrinsic___090adfe379c447b396020a430db68fa6___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { double, %Qubit* }* }, { %Array*, { double, %Qubit* }* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___d09908006690421cab92bd78d346ff27___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___0e27d13d8cb34a28b2100e2bc596a1f9___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { %Qubit*, %Qubit* }* }, { %Array*, { %Qubit*, %Qubit* }* }* %0, i32 0, i32 0

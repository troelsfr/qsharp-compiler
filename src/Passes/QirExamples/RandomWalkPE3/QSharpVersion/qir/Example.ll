...
define internal double @Microsoft__Quantum__Qir__Emission__ClassicalComputeInput1__body(double %mu, double %sigma) {
entry:
  %0 = call double @Microsoft__Quantum__Math__PI__body()
  %1 = fdiv double %0, 2.000000e+00
  %2 = fdiv double %mu, %sigma
  %3 = fsub double %1, %2
  ret double %3
}
...
define internal double @Microsoft__Quantum__Qir__Emission__ClassicalComputeInput2__body(double %mu, double %sigma) {
entry:
  %0 = call double @Microsoft__Quantum__Math__PI__body()
  %1 = call double @Microsoft__Quantum__Math__PI__body()
  %2 = fmul double %1, %sigma
...
define internal double @Microsoft__Quantum__Qir__Emission__ClassicalUpdateSigma__body(double %sigma) {
entry:
  %0 = fmul double %sigma, 7.951000e-01
  ret double %0
}

define internal void @Microsoft__Quantum__Qir__Emission__CRz__body(double %theta, %Qubit* %control, %Qubit* %target) {
entry:
  call void @__quantum__qis__crz__body(double %theta, %Qubit* %control, %Qubit* %target)
  ret void
}

declare void @__quantum__qis__crz__body(double, %Qubit*, %Qubit*)

define internal double @Microsoft__Quantum__Qir__Emission__EstimatePhaseByRandomWalk__body() {
entry:
  ...
  %0 = call double @Microsoft__Quantum__Qir__Emission__IterationLoop__body(i64 20, double 7.951000e-01, double 6.065000e-01, %Qubit* %target, %Qubit* %aux)
...
define internal void @Microsoft__Quantum__Qir__Emission__Prepare__body(%Qubit* %target) {
entry:
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %target)
  ret void
}

define internal double @Microsoft__Quantum__Qir__Emission__IterationLoop__body(i64 %n, double %mu, double %sigma, %Qubit* %target, %Qubit* %aux) {
entry:
  %0 = icmp eq i64 %n, 0
...
continue__1:                                      ; preds = %entry
  %c1 = call double @Microsoft__Quantum__Qir__Emission__ClassicalComputeInput1__body(double %mu, double %sigma)
  %c2 = call double @Microsoft__Quantum__Qir__Emission__ClassicalComputeInput2__body(double %mu, double %sigma)
  %datum = call %Result* @Microsoft__Quantum__Qir__Emission__Iterate__body(double %c1, double %c2, %Qubit* %target, %Qubit* %aux)
  %newSigma = call double @Microsoft__Quantum__Qir__Emission__ClassicalUpdateSigma__body(double %sigma)
  %1 = call %Result* @__quantum__rt__result_get_zero()
  %2 = call i1 @__quantum__rt__result_equal(%Result* %datum, %Result* %1)
  br i1 %2, label %then0__2, label %continue__2

then0__2:                                         ; preds = %continue__1
  %3 = sub i64 %n, 1
  %4 = fmul double %sigma, 6.065000e-01
  %5 = fsub double %mu, %4
  %6 = call double @Microsoft__Quantum__Qir__Emission__IterationLoop__body(i64 %3, double %5, double %newSigma, %Qubit* %target, %Qubit* %aux)
  call void @__quantum__rt__result_update_reference_count(%Result* %datum, i32 -1)
  ret double %6

continue__2:                                      ; preds = %continue__1
  %7 = sub i64 %n, 1
  %8 = fmul double %sigma, 6.065000e-01
  %9 = fadd double %mu, %8
  %10 = call double @Microsoft__Quantum__Qir__Emission__IterationLoop__body(i64 %7, double %9, double %newSigma, %Qubit* %target, %Qubit* %aux)
  call void @__quantum__rt__result_update_reference_count(%Result* %datum, i32 -1)
  ret double %10
}

define internal %Result* @Microsoft__Quantum__Qir__Emission__Iterate__body(double %c1, double %c2, %Qubit* %target, %Qubit* %aux) {
entry:
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %aux)
  call void @Microsoft__Quantum__Intrinsic__Rz__body(double %c1, %Qubit* %aux)
  call void @__quantum__qis__crz__body(double %c2, %Qubit* %aux, %Qubit* %target)
  call void @Microsoft__Quantum__Intrinsic__H__adj(%Qubit* %aux)
  %0 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body(%Qubit* %aux)
  ret %Result* %0
}
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___af4242c853ad4464b2babedaea7dc3e8___QsRef23__ApplyWithLessControlsA____body(%Callable* %47, { %Array*, %Qubit* }* %49)
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___af4242c853ad4464b2babedaea7dc3e8___QsRef23__ApplyWithLessControlsA____body(%Callable* %14, { %Array*, %Qubit* }* %16)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___babd36f08c944f08b9cf2c179e0a3148___QsRef23__ApplyWithLessControlsA____body(%Callable* %10, { %Array*, { %Qubit*, %Qubit* }* }* %12)
...
define internal void @Microsoft__Quantum__Intrinsic___babd36f08c944f08b9cf2c179e0a3148___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___af4242c853ad4464b2babedaea7dc3e8___QsRef23__ApplyWithLessControlsA____body(%Callable* %7, { %Array*, %Qubit* }* %9)
...
define internal void @Microsoft__Quantum__Intrinsic___af4242c853ad4464b2babedaea7dc3e8___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___3b1fa33d3233476785332ca0e31f1a48___QsRef23__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, { double, %Qubit* }* }* %17)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___3b1fa33d3233476785332ca0e31f1a48___QsRef23__ApplyWithLessControlsA____body(%Callable* %16, { %Array*, { double, %Qubit* }* }* %18)
...
define internal void @Microsoft__Quantum__Intrinsic___3b1fa33d3233476785332ca0e31f1a48___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  store %Qubit* %qubit, %Qubit** %17, align 8
  call void @Microsoft__Quantum__Intrinsic___af4242c853ad4464b2babedaea7dc3e8___QsRef23__ApplyWithLessControlsA____body(%Callable* %13, { %Array*, %Qubit* }* %15)
...
define internal void @Microsoft__Quantum__Intrinsic___3b1fa33d3233476785332ca0e31f1a48___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { double, %Qubit* }* }, { %Array*, { double, %Qubit* }* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___af4242c853ad4464b2babedaea7dc3e8___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___babd36f08c944f08b9cf2c179e0a3148___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { %Qubit*, %Qubit* }* }, { %Array*, { %Qubit*, %Qubit* }* }* %0, i32 0, i32 0
...
define double @Microsoft__Quantum__Qir__Emission__EstimatePhaseByRandomWalk__Interop() #1 {
entry:
  %0 = call double @Microsoft__Quantum__Qir__Emission__EstimatePhaseByRandomWalk__body()
  ret double %0
}

define void @Microsoft__Quantum__Qir__Emission__EstimatePhaseByRandomWalk() #2 {
entry:
  %0 = call double @Microsoft__Quantum__Qir__Emission__EstimatePhaseByRandomWalk__body()
